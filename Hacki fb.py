...
def banner():
    os.system('clear')
    print " "
    runntxt(GL+"              Rishi@sahu. ^_^")
    runntxt(WW+"   ..................  MY YOUTUBE HACKING BAY")
    runntxt(WW+"     ....       MR.RUSHI")
    runntxt(GL+"                   HACKIR ")
    runntxt(GG+"     ..........     BHATPALA")
    runntxt(Y+"    ............       LILI SAH*U")
    runntxt(GG+"           LIKE ")
    time.sleep(1.5)
    print GG+"  √=============================================√"
    print GL+"  |••••••   BAST TOOLS HACK FACEBOOK MY.   ••••••|"
    print GG+"  √=============================================√"
    print WW+"  |            MOD BY: MR.RUSHI SAHU            |"
    print GL+"  |       HI I.LOVE YOU    HACKIN   BAY  LILI   |"
    print WW+"  |        address: BHATAPALA Kala Munda       |"
    print Y+"  |             INSTAGRAM: INDIA              |"
    print GL+"  |---------------------------------------------|"
    print GL+"  |        MO- 9556615190  [ I.L.O ]         |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
    print GL+"  |•••••••••   HACK FAHACKI ^_^   •••••••••|"
    print GG+"  √=============================================√"
